        ...
        <div className="App">
          <header className="App-header">
            ...
            <ul>
              ...
              <li>
                {user ? (
                  <Link to="/new-post">New ChatZ</Link>
                ) : (
            ...
            <Switch>
              <Route exact path="/">
                {user ? (
                  ...
                  <React.Fragment>Hello! Welcome to Locale ChatterZ. Please Register or Login to view your personal account messages!</React.Fragment>
                )}
              </Route>
